...
export default function AIWritingAssistant({
  ...
  return (
    ...
    >
      {/* Header - 可拖拽 */}
      <div
        className="flex items-center justify-between px-3 py-2 border-b border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-800/30 cursor-move select-none"
